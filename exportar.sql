...
REM INSERTING INTO AUCTION_CREATOR
SET DEFINE OFF;
...
REM INSERTING INTO DONATION_CREATOR
SET DEFINE OFF;
...
REM INSERTING INTO EXCHANGE_CREATOR
SET DEFINE OFF;
...
REM INSERTING INTO SERVICE_CREATOR
SET DEFINE OFF;
...
REM INSERTING INTO SIMPLE_CREATOR
SET DEFINE OFF;
...
ALTER TABLE "AUCTION_CREATOR" ADD CONSTRAINT "CREATOR"
FOREIGN KEY ("CREATOR") REFERENCES "USERS" ("EMAIL") ENABLE;


ALTER TABLE "AUCTION_CREATOR" ADD CONSTRAINT "AUCTION"
FOREIGN KEY ("AUCTION") REFERENCES "AUCTION" ("ID") ENABLE;
...
ALTER TABLE "DONATION_CREATOR" ADD CONSTRAINT "CREATOR3"
FOREIGN KEY ("CREATOR") REFERENCES "USERS" ("EMAIL") ENABLE;


ALTER TABLE "DONATION_CREATOR" ADD CONSTRAINT "DONATION"
...
ALTER TABLE "EXCHANGE_CREATOR" ADD CONSTRAINT "EXCHANGE"
FOREIGN KEY ("EXCHANGE") REFERENCES "EXCHANGE" ("ID") ENABLE;


ALTER TABLE "EXCHANGE_CREATOR" ADD CONSTRAINT "CREATOR1"
FOREIGN KEY ("CREATOR") REFERENCES "USERS" ("EMAIL") ENABLE;
...
ALTER TABLE "SERVICE_CREATOR" ADD CONSTRAINT "CREATOR4"
FOREIGN KEY ("CREATOR") REFERENCES "USERS" ("EMAIL") ENABLE;


ALTER TABLE "SERVICE_CREATOR" ADD CONSTRAINT "SIMPLE1"
...
ALTER TABLE "SIMPLE_CREATOR" ADD CONSTRAINT "CREATOR2"
FOREIGN KEY ("CREATOR") REFERENCES "USERS" ("EMAIL") ENABLE;


ALTER TABLE "SIMPLE_CREATOR" ADD CONSTRAINT "SIMPLE"
FOREIGN KEY ("SIMPLE") REFERENCES "SIMPLE" ("ID") ENABLE;
