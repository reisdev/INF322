...
ALTER TABLE "ITEM"
  MODIFY ("DESCRIPTION" NOT NULL ENABLE);
ALTER TABLE "ITEM"
  MODIFY ("CATEGORY" NOT NULL ENABLE);
ALTER TABLE "ITEM"
  ADD CONSTRAINT "ITEM_PK" PRIMARY KEY ("NAME")
...
ALTER TABLE "DONATION_CREATOR"
  MODIFY ("CREATOR" NOT NULL ENABLE);
ALTER TABLE "DONATION_CREATOR"
  MODIFY ("DONATION" NOT NULL ENABLE);
--------------------------------------------------------
...
ALTER TABLE "DONATION"
  MODIFY ("ITEM" NOT NULL ENABLE);
ALTER TABLE "DONATION"
  MODIFY ("POST_DATE" NOT NULL ENABLE);
ALTER TABLE "DONATION"
...
ALTER TABLE "AUCTION"
  MODIFY ("POST_DATE" NOT NULL ENABLE);
ALTER TABLE "AUCTION"
  MODIFY ("INITIAL_PRICE" NOT NULL ENABLE);
ALTER TABLE "AUCTION"
...
ALTER TABLE "SIMPLE_CREATOR"
  MODIFY ("CREATOR" NOT NULL ENABLE);
ALTER TABLE "SIMPLE_CREATOR"
  MODIFY ("SIMPLE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table EXCHANGE_CREATOR
--------------------------------------------------------

ALTER TABLE "EXCHANGE_CREATOR"
  MODIFY ("CREATOR" NOT NULL ENABLE);
ALTER TABLE "EXCHANGE_CREATOR"
  MODIFY ("EXCHANGE" NOT NULL ENABLE);
--------------------------------------------------------
...
ALTER TABLE "AUCTION_CREATOR"
  MODIFY ("CREATOR" NOT NULL ENABLE);
ALTER TABLE "AUCTION_CREATOR"
  MODIFY ("AUCTION" NOT NULL ENABLE);
--------------------------------------------------------
...
ALTER TABLE "SERVICE"
  MODIFY ("TIME_TYPE" NOT NULL ENABLE);
ALTER TABLE "SERVICE"
  MODIFY ("PRICE" NOT NULL ENABLE);
ALTER TABLE "SERVICE"
  MODIFY ("POST_DATE" NOT NULL ENABLE);
...
ALTER TABLE "USERS"
  MODIFY ("EMAIL" NOT NULL ENABLE);
ALTER TABLE "USERS"
  ADD CONSTRAINT "USERS_PK" PRIMARY KEY ("EMAIL")
    USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
      TABLESPACE "USERS" ENABLE;
ALTER TABLE "USERS"
  MODIFY ("ADDRESS" NOT NULL ENABLE);
ALTER TABLE "USERS"
  MODIFY ("NAME" NOT NULL ENABLE);
ALTER TABLE "USERS"
  MODIFY ("NICKNAME" NOT NULL ENABLE);
ALTER TABLE "USERS"
  MODIFY ("PHONES" NOT NULL ENABLE);
ALTER TABLE "USERS"
...
ALTER TABLE "AUCTION"
  ADD CONSTRAINT "ITEM" FOREIGN KEY ("ITEM")
...
ALTER TABLE "AUCTION_BIDS"
  ADD CONSTRAINT "AUCTION_ID" FOREIGN KEY ("AUCTION")
    REFERENCES "AUCTION" ("ID") ENABLE;
ALTER TABLE "AUCTION_BIDS"
  ADD CONSTRAINT "BIDDER" FOREIGN KEY ("BIDDER")
...
ALTER TABLE "AUCTION_CREATOR"
  ADD CONSTRAINT "CREATOR" FOREIGN KEY ("CREATOR")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "AUCTION_CREATOR"
  ADD CONSTRAINT "AUCTION" FOREIGN KEY ("AUCTION")
    REFERENCES "AUCTION" ("ID") ENABLE;
--------------------------------------------------------
...
ALTER TABLE "DONATION"
  ADD CONSTRAINT "ITEMD" FOREIGN KEY ("ITEM")
    REFERENCES "ITEM" ("NAME") ENABLE;
--------------------------------------------------------
...
ALTER TABLE "DONATION_CREATOR"
  ADD CONSTRAINT "CREATOR3" FOREIGN KEY ("CREATOR")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "DONATION_CREATOR"
  ADD CONSTRAINT "DONATION" FOREIGN KEY ("DONATION")
    REFERENCES "DONATION" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DONATION_DONATEE
--------------------------------------------------------

ALTER TABLE "DONATION_DONATEE"
  ADD CONSTRAINT "BUYER1" FOREIGN KEY ("BUYER")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "DONATION_DONATEE"
  ADD CONSTRAINT "EXCHANGE_TABLE1" FOREIGN KEY ("QUANTITY")
    REFERENCES "DONATION" ("ID") ENABLE;
--------------------------------------------------------
...
ALTER TABLE "EXCHANGE"
  ADD CONSTRAINT "ITEME" FOREIGN KEY ("ITEM")
    REFERENCES "ITEM" ("NAME") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EXCHANGE_BUYER
--------------------------------------------------------

ALTER TABLE "EXCHANGE_BUYER"
  ADD CONSTRAINT "BUYER" FOREIGN KEY ("BUYER")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "EXCHANGE_BUYER"
  ADD CONSTRAINT "EXCHANGE_TABLE" FOREIGN KEY ("EXCHANGE")
    REFERENCES "EXCHANGE" ("ID") ENABLE;
ALTER TABLE "EXCHANGE_BUYER"
  ADD CONSTRAINT "ITEM_OFFERED" FOREIGN KEY ("ITEM")
    REFERENCES "ITEM" ("NAME") ENABLE;
--------------------------------------------------------
...
ALTER TABLE "EXCHANGE_CREATOR"
  ADD CONSTRAINT "EXCHANGE" FOREIGN KEY ("EXCHANGE")
    REFERENCES "EXCHANGE" ("ID") ENABLE;
ALTER TABLE "EXCHANGE_CREATOR"
  ADD CONSTRAINT "CREATOR1" FOREIGN KEY ("CREATOR")
    REFERENCES "USERS" ("EMAIL") ENABLE;
--------------------------------------------------------
...
ALTER TABLE "SERVICE_CONTRACTOR"
  ADD CONSTRAINT "BUYER3" FOREIGN KEY ("CONTRACTOR")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "SERVICE_CONTRACTOR"
  ADD CONSTRAINT "CONTRACTOR" FOREIGN KEY ("SIMPLE")
...
ALTER TABLE "SERVICE_CREATOR"
  ADD CONSTRAINT "CREATOR4" FOREIGN KEY ("CREATOR")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "SERVICE_CREATOR"
  ADD CONSTRAINT "SIMPLE1" FOREIGN KEY ("SERVICE")
    REFERENCES "SERVICE" ("ID") ENABLE;
--------------------------------------------------------
...
ALTER TABLE "SIMPLE"
  ADD CONSTRAINT "ITEMS" FOREIGN KEY ("ITEM")
    REFERENCES "ITEM" ("NAME") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SIMPLE_BUYER
--------------------------------------------------------

ALTER TABLE "SIMPLE_BUYER"
  ADD CONSTRAINT "BUYER2" FOREIGN KEY ("BUYER")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "SIMPLE_BUYER"
  ADD CONSTRAINT "EXCHANGE_TABLE2" FOREIGN KEY ("SIMPLE")
...
ALTER TABLE "SIMPLE_CREATOR"
  ADD CONSTRAINT "CREATOR2" FOREIGN KEY ("CREATOR")
    REFERENCES "USERS" ("EMAIL") ENABLE;
ALTER TABLE "SIMPLE_CREATOR"
  ADD CONSTRAINT "SIMPLE" FOREIGN KEY ("SIMPLE")
    REFERENCES "SIMPLE" ("ID") ENABLE;
