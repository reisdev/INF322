...
class Database:
    ...
    def testInsert(self):
        c = self.con.cursor()
        c.execute(
            "INSERT INTO USERS (email,fullname,nickname,addresses,phones)"
            "VALUES ('matheusdrdj@gmail.com','Matheus dos Reis de Jesus','mthrsj', T_LIST_ADDRESSES(T_ADDRESS(501,'14','Promissão II','Lagoa Santa')),T_PHONES('31993102771'))")
        self.con.commit()
